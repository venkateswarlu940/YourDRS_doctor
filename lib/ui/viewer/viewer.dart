  ...
  Future<void> _showMyDialog() async {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('AlertDialog',style: TextStyle(fontFamily: AppFonts.regular,),),
          content: SingleChildScrollView(
            child: Text('Leading navigation button has been pressed.',style: TextStyle(fontFamily: AppFonts.regular,),),
          ),
          actions: <Widget>[
            TextButton(
              child: Text('OK',style: TextStyle(fontFamily: AppFonts.regular,),),
              onPressed: () {
